...
import 'package:project_manager/modules/all_users_page/user_edit_page.dart';
                      ...
                      itemBuilder: (context, index) =>
                          GestureDetector(
                            onTap: () {
                              navigateTo(
                                context,
                                EditUsers(index: index, l1: doctoList)
                              );
                            },
                            child: buildUserItem(name:doctoList[index]['name'] , id: doctoList[index]['university_id'])
                            ),
