...
class _AddMoreDoctorsState extends State<AddMoreDoctors> {
 ...
 addMoreDoctor() async {
      ...
      showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: const Text("Insert error"),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.pop(context);
  ...
  var doctorName2 = TextEditingController();
  var doctorName3 = TextEditingController();
  var doctorName4 = TextEditingController();
  var doctorName5 = TextEditingController();
  var doctorName6 = TextEditingController();
